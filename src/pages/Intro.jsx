function Intro() {
  return (
    <>
      ...
      <h4 className="introTitle">Participant Code:</h4>
      <p className="introParagraph">Blabla</p>

      <h4 className="introTitle">Principal Investigator: </h4>
      <p className="introParagraph">Jihyun Park (jihyun.park@inria.fr)</p>

      <h4 className="introTitle">Supervisors: </h4>
      ...
      <p className="introParagraph">
        By signing the consent form, you certify that you have read and
